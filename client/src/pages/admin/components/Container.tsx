                ...
                <div className='user'>
                    <Dropdown>
                        <Dropdown.Toggle variant="success" id="dropdown-basic">
                            ...
                            <span style={{ color: '#fff' }}><strong style={{ color: '#fff' }}>Hi</strong> Admin </span>
                        </Dropdown.Toggle>
                    </Dropdown>
                </div>
                {
                    menus.map(item => (
                        <div key={Date.now() * Math.random()} className='menu_item' >
                            <div className="voltage-button" onClick={(e: React.MouseEvent<HTMLDivElement>) => {
                                 const targetEl = e.currentTarget.parentNode?.querySelector('.menu_item_sub');
                                 if (targetEl?.classList.length && targetEl?.classList.contains("hidden")) {
                                ...
                                <button>
                                    <i className="fa-solid fa-list"></i> {item.title}
                                </button>
                            ...
                            <ul className='menu_item_sub'>
                                {
                                    ...
                                    }} key={Date.now() * Math.random()}><i className="fa-solid fa-bolt"></i> {supItem.title} <i className="fa-solid fa-bolt"></i></li>))
                                }
                            </ul>
                        </div>
                    ))
